<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Expediente.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Expediente" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Expediente Cliente</title>
            ...
            <div class="row">
                 <div class="col-lg-3 col-md-6">
                    <div class="class-item">
                        ...
                        <div class="ci-text">
                            <h5>Calculadora</h5>
                            <a href="./Wfrm_Cliente_Calculadora.aspx"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="class-item">
                        <div class="ci-pic">
                            <img src="Recursos/img/letest-blog/latest-2.jpg" alt="" />
                        </div>
                        <div class="ci-text">
                            <h5>Mediciones</h5>
                            <a href="./Wfrm_Cliente_Mediciones.aspx"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="class-item">
                        ...
                        <div class="ci-text">
                            <h5>Progreso</h5>
                            <a href="./Wfrm_Cliente_Progreso.aspx"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="class-item">
                        ...
                        <div class="ci-text">
                            <h5>Rutinas</h5>
                            <a href="./Wfrm_Cliente_Rutinas.aspx"><i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
