<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_PreRegistro.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_PreRegistro" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Registro Cliente</title>
    <!--CAMBIAR NOMBRE-->
...
<body>
                    ...
                    <div class="chart-calculate-form">
                        ...
                        <form action="#">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <button type="submit" onclick="CrearPreregistro();">Crear Cuenta</button>
                                </div>
                                <div class="col-lg-3">
                                </div>
                            </div>
    ...
    <script src="Recursos/js/Clientes/js_cliente_preregistro.js"></script>
