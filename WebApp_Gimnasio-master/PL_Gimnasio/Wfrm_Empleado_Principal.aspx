<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Empleado_Principal.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Empleado_Principal" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Inicio Colaborador</title>
...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <nav class="nav-menu">
                        <ul>
                            <li><a class="nav-item active" href="Wfrm_Empleado_Principal.aspx">Inicio</a></li>
    ...
    <section class="choseus-section spad noDisplay" id="Administracion">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="bs-text">
                        <br />
                        <br />
                        <h3 style="color: #ffffff">ADMINISTRACIÓN</h3>
                    </div>
                </div>
                <div id="principalMenuInformes" class="noDisplay col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Administracion_Informes.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Informes</h4>
                    </div>
                </div>
                <div id="principalMenuInventario" class="noDisplay col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Inventario.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Inventario</h4>
                    </div>
                </div>
                <div id="principalMenuFacturacion" class="noDisplay col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Facturacion_Factura.aspx"><span class="flaticon-025-fitness-1"></span></a>
                        <h4>Facturación</h4>
                    </div>
                </div>
                <div id="principalMenuConfirmacion" class="noDisplay col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Confirmar_Pago.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Confirmación</h4>
                    </div>
                </div>
            </div>
    ...
    <section class="choseus-section noDisplay" id="Gestion" style="background-color: #151515;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="bs-text">
                        <br />
                        <br />
                        <h3 style="color: #ffffff">GESTIÓN USUARIOS</h3>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Empleado_Cliente.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Clientes</h4>
                    </div>
                </div>                
            </div>
    ...
    <!--SECCION AGENDA-->
    <section class="choseus-section noDisplay" id="Agenda">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="bs-text">
                        <br />
                        <br />
                        <h3 style="color: #ffffff">AGENDA</h3>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Empleado_Agenda_Sesion.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Sesiones Individuales</h4>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Empleado_Agenda_Clase.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Sesiones Grupales</h4>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Empleado_Agenda_Cita.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Valoraciones</h4>
                    </div>
                </div>
            </div>
    ...
    <section class="choseus-section noDisplay" id="Trainer" style="background-color: #151515;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="bs-text">
                        <br />
                        <br />
                        <h3 style="color: #ffffff">ENTRENADORES</h3>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Entrenador_Clases.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Gestión de Clases</h4>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Entrenador_Expediente.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Expediente de Cliente</h4>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Entrenador_Rutinas.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Rutinas de Cliente</h4>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--SECCION SEGURIDAD-->
    <section class="choseus-section noDisplay" id="Seguridad">
        <div class="container">
            <div class="row">
            </div>
            <div class="row">
                ...
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Usuario_Contrasenna.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Cambio de Contraseña</h4>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Empleado_Roles.aspx"><span class="flaticon-004-measuring-tape"></span></a>
                        <h4>Roles</h4>
                    </div>
                </div>
            </div>
    ...
    <section class="choseus-section noDisplay" id="Config" style="background-color: #151515;">
        <div class="container">
            <div class="row">
            </div>
            <div class="row">
                <div class="col-lg-4">
                    <div class="bs-text">
                        <br />
                        <br />
                        <h3 style="color: #ffffff">CONFIGURACIÓN</h3>
                    </div>
                </div>
                <div class="col-lg-2">
                    <div class="cs-item">
                        <a href="Wfrm_Configuraciones_Parametros.aspx"><span class="flaticon-018-scale"></span></a>
                        <h4>Parámetros</h4>
                    </div>
                </div>
            </div>
