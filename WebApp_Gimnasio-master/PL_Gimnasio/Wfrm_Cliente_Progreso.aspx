<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Progreso.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Progreso" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Progreso Cliente</title>
...
<body>
    ...
    <!--SECCION PROGRESO-->
    <section class="classes-section spad" id="Rutinas">
        <div class="container">
            <div class="row">
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoPeso"></div>
                </figure>
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoGrasa"></div>
                </figure>
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoMusculo"></div>
                </figure>
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoHueso"></div>
                </figure>
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoAgua"></div>
                </figure>
                <figure class="highcharts-figure col-md-6">
                    <div id="graficoIMC"></div>
                </figure>
            </div>
        </div>
    </section>
    ...
    <script src="Recursos/js/Clientes/js_cliente_progreso.js"></script>
