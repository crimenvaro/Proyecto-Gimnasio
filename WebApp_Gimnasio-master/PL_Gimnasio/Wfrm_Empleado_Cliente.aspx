<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Empleado_Cliente.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Empleado_Cliente" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Clientes</title>
...
<body>
                ...
                <div class="col-lg-8">
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <li id="menuUsuarios" class="noDisplay nav-item dropdown active">
        ...
        <div class="container">
            ...
            <div class="row section-tabla">
                ...
                <div class="form-section col-lg-3 col-md-3">
                    <input type="button" class="pull-right btn-form" data-toggle="modal" data-target="#ModalNuevoCliente" value="Adicionar Cliente" />
                </div>

                <div class="panel-body row col-lg-12 col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTable-lista-clientes">
                            <thead>
                                <tr>
    ...
    <!-- Modal -->
    <div class="modal fade" id="ModalNuevoCliente" tabindex="-1" role="dialog" aria-labelledby="ModalNuevoClienteCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalNuevoClienteLongTitle">Insertar Cliente</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="row col-lg-12 col-md-12">
                                <input type="hidden" name="inpHidIdCliente" id="inpHidIdCliente" value="0" />
                                <input type="hidden" name="inpHidIdPersona" id="inpHidIdPersona" value="0" />
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Identificación:</label>
                                    <input id="inpNuevoIdentificacion" class="col-lg-6 col-md-6" type="text" placeholder="Identificación" maxlength="12" onpaste="return false" ondrop="return false" onkeyup="javascript: this.value = this.value.toUpperCase();" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Nombre:</label>
                                    <input id="inpNuevoNombre" class="col-lg-6 col-md-6" type="text" placeholder="Nombre" maxlength="50" onkeypress="return SoloLetras()" onpaste="return false" ondrop="return false" onkeyup="javascript: this.value = this.value.toUpperCase();" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Apellido 1:</label>
                                    <input id="inpNuevoApellido1" class="col-lg-6 col-md-6" type="text" placeholder="Primer Apellido" maxlength="50" onkeypress="return SoloLetras()" onpaste="return false" ondrop="return false" onkeyup="javascript: this.value = this.value.toUpperCase();" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Apellido 2:</label>
                                    <input id="inpNuevoApellido2" class="col-lg-6 col-md-6" type="text" placeholder="Segundo Apellido" maxlength="50" onkeypress="return SoloLetras()" onpaste="return false" ondrop="return false" onkeyup="javascript: this.value = this.value.toUpperCase();" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Nacimiento:</label>
                                    <input id="inpNuevoFechaNacimiento" class="col-lg-6 col-md-6" type="date" placeholder="AAAA-MM-DD" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Teléfono:</label>
                                    <input id="inpNuevoTelefono" class="col-lg-6 col-md-6" type="text" placeholder="Teléfono" maxlength="8" onkeypress="return SoloNumeros()" onpaste="return false" ondrop="return false" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Correo:</label>
                                    <input id="inpNuevoCorreo1" class="col-lg-6 col-md-6" type="text" placeholder="Correo" maxlength="254"/>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Correo 2:</label>
                                    <input id="inpNuevoCorreo2" class="col-lg-6 col-md-6" type="text" placeholder="Correo 2" maxlength="254" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Usuario:</label>
                                    <input id="inpNuevoUsuario" class="col-lg-6 col-md-6" type="text" placeholder="Usuario" maxlength="30" />
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Plan:</label>
                                    <select id="selPlanCliente" class="col-lg-6 col-md-6" >
                                    </select>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <label class="col-lg-5 col-md-5">Estado:</label>
                                    <select id="selEstadoCliente" class="col-lg-6 col-md-6" >
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" onclick="GuardarEliminarCliente();">Guardar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="Recursos/js/Colaboradores/js_empleado_cliente.js"></script>
