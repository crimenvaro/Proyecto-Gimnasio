<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Membresia.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Membresia" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Membresía Cliente</title>
                ...
                <div class="col-lg-7">
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <li class="active"><a href="./Wfrm_Cliente_Membresia.aspx">Membresía</a>
                                <ul class="dropdown">
