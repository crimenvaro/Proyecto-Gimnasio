<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Clases.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Clases" %>
...
<head>
    ...
    <title>Platinum Gym - Clases</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <nav class="nav-menu">
                        <ul>
                            <li><a href="./Wfrm_Principal.aspx">Inicio</a></li>
                            <li class="active"><a href="./Wfrm_Clases.aspx">Clases</a></li>
                            <li><a href="./Wfrm_Servicios.aspx">Servicios</a></li>
                            <li><a href="./Wfrm_Entrenadores.aspx">Entrenadores</a></li>
                            <li><a href="./Wfrm_Metricas.aspx">Métricas</a></li>
                            <li><a href="./Wfrm_Nosotros.aspx">Nosotros</a></li>
