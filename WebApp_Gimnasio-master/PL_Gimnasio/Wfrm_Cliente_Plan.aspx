<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Plan.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Plan" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Planes Cliente</title>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="ps-item">
                        ...
                        <a href="#" class="primary-btn pricing-btn">Cambiar plan</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8">
                    <div class="ps-item plan-activo">
                        <h3>Mes ilimitado</h3>
                        <div class="pi-price">
                            <h2>$ 80.0</h2>
                        ...
                        <a href="#" class="primary-btn pricing-btn">Plan actual</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-8">
                    <div class="ps-item">
