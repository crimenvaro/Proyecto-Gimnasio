<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Pagos.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Pagos" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Pagos Cliente</title>
...
<body>
    ...
    <!--SECCION PENDIENTES-->
    <section class="classes-section spad" id="Pendientes">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bs-text">
                                ...
                                <div class="col-md-12">
                                    <div class="cd-medidas-text">
                                        ...
                                        <ul class="trainer-info">                                            
                                            <li><span>Plan Ilimitado</span> $80.00</li>
                                        </ul>
                                    </div>
                                    <div class="cd-medidas-text">
                                        <div class="trainer-title">
    ...
    <!--SECCION HISTORICO-->
    <section class="classes-section" id="Historico">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bs-text">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="cd-medidas-text">
                                        ...
                                        <ul class="trainer-info">
                                            <li><span>Matrícula</span>$45.00</li>
                                            <li><span>Plan Ilimitado</span> $80.00</li>
                                        </ul>
                                    </div>
                                    <div class="cd-medidas-text">
