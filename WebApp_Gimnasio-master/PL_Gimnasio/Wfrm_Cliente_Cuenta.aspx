<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Cliente_Cuenta.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Cliente_Cuenta" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Cuenta Cliente</title>
...
<body>
    ...
    <section class="classes-section spad" id="Cuenta">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="bs-text">
