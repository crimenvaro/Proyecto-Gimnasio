<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Usuario_Contrasenna.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Usuario_Contrasenna" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Seguridad Usuario Contraseña</title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb-text">
                        <h2>Recordar Usuario o Contraseña</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTable-lista-clientes">
                            <thead>
                                <tr>
                                    ...
                                    <th>Usuario</th>
                                    <th>Recordar Contraseña</th>
                                    <th>Recordar Correo</th>
                                </tr>
                            </thead>
                            <tbody id="tablaUsuarioContrasenna">
                            </tbody>
                        </table>
                    </div>
    ...
    <script src="Recursos/js/Colaboradores/js_usuario_contrasenna.js"></script>
</body>
