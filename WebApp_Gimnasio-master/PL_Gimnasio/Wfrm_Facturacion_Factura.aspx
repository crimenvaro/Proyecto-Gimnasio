<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Facturacion_Factura.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Facturacion_Factura" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Facturación</title>
    ...
    <link rel="stylesheet" href="Recursos/css/css_facturacion.css" type="text/css" />
...
<body>
        ...
        <div class="container">
            ...
            <div class="section-tabla row col-lg-12 col-md-12">
                ...
                <div class="form-section col-lg-3 col-md-3">
                    <input type="button" class="pull-right btn-form noDisplay" data-toggle="modal" data-target="#ModalNuevoProducto" value="Adicionar Producto" />
                </div>
            </div>

            <div class="row section-tabla">
                <table class="table table-striped table-bordered table-hover" id="dataTable-factura">
                    <thead>
                        <tr>
                            <th>Descuento</th>
                            <th>Condonación</th>
                            ...
                            <th>Descuento</th>
                            <th>IVA</th>
                            <th class="w170">Total</th>
                            <th class="w170">Pagar</th>
                        </tr>
                    </thead>
            ...
            <div class="row">
                <div class="row-wrapper">
                    <div class="row-resultados">
                        <div class="row-resultados-titulo">Subtotal ₡:</div>
                        <div class="row-resultados-valor" id="idSubtotal">0,00</div>
                    </div>
                </div>
                <div class="row-wrapper">
                    <div class="row-resultados">
                        <div class="row-resultados-titulo">Descuentos ₡:</div>
                        <div class="row-resultados-valor" id="idDescuento">0,00</div>
                    </div>
                </div>
                <div class="row-wrapper">
                    <div class="row-resultados">
                        <div class="row-resultados-titulo">IVA ₡:</div>
                        <div class="row-resultados-valor" id="idIVA">0,00</div>
                    </div>
                </div>
                <div class="row-wrapper">
                    <div class="row-resultados">
                        <div class="row-resultados-titulo">Total ₡:</div>
                        <div class="row-resultados-valor" id="idTotal">0,00</div>
                    </div>
                </div>
            </div>
            <div class="row col-lg-12 col-md-12 top20">
                <input type="button" class="col-lg-3 col-md-3" value="Ver Historial" />
            </div>
        </div>
    </section>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="ModalDescuento">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="row col-lg-11 col-md-11">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <label class="col-lg-5 col-md-5">Comentario:</label>
                                    <input id="inpComentarioDescuento" class="col-lg-6 col-md-6" type="text" placeholder="Comentario" maxlength="250"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="GuardarDescuento();">Aplicar</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="ModalCondonacion">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Condonar Pago</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="row col-lg-11 col-md-11">
                                <div class="col-lg-12 col-md-12">
                                    <label class="col-lg-12 col-md-12">Se aplicará una condonación al pago, ¿está seguro de realizar esta acción?</label>
                                </div>
                                <div class="col-lg-12 col-md-12">
                                    <label class="col-lg-5 col-md-5">Comentario:</label>
                                    <input id="inpComentarioCondonacion" class="col-lg-6 col-md-6" type="text" placeholder="Comentario"  maxlength="250"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" onclick="GuardarCondonacion();">Aplicar</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal" tabindex="-1" role="dialog" id="ModalPagar">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Pagar o Notificar</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            <div class="row col-lg-11 col-md-11">
                                <div class="col-lg-12 col-md-12">
                                    <label class="col-lg-5 col-md-5">Tipo de Pago:</label>
                ...
                <div class="modal-footer">
                    <button id="btnAplicarPago" type="button" class="btn btn-primary" onclick="AplicarPago();">Aplicar</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                </div>
            </div>
        </div>
    ...
    <script src="Recursos/js/Colaboradores/js_facturacion.js"></script>
