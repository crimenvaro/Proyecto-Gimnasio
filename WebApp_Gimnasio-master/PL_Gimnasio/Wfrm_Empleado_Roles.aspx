<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Wfrm_Empleado_Roles.aspx.cs" Inherits="PL_Gimnasio.Wfrm_Empleado_Roles" %>
...
<head runat="server">
    ...
    <title>Platinum Gym - Roles Usuario</title>
...
<body>
                ...
                <div class="col-lg-8">
                    <nav class="nav-menu">
                        <ul>
                            ...
                            <li id="menuSeguridad" class="noDisplay nav-item dropdown active">
        ...
        <div class="container">
            <div class="row col-lg-12 col-md-12">
                <div class="col-lg-4 col-md-4">
                    ...
                    <input id="inpIdentificacion" class="col-lg-5 col-md-5" type="text" value="" placeholder="Identificación" disabled="disabled" />
                    <span class="btn-search fa fa-search" data-toggle="modal" data-target="#ModalBuscador"></span>
                </div>
                <div class="col-lg-4 col-md-4">
                    <label class="col-mlg-5 col-md-5">Teléfono:</label>
                    <input id="inpTelefono" class="col-lg-6 col-md-6" type="text" value="" placeholder="Teléfono" disabled="disabled" />
                </div>
                <div class="col-lg-4 col-md-4">
                    <label class="col-lg-5 col-md-5">Correo:</label>
                    <input id="inpCorreo" class="col-lg-6 col-md-6" type="text" value="" placeholder="Correo" disabled="disabled" />
                </div>
            </div>

            <div id="usuarioSeleccionado"></div>

            <!--SECCION CLASES-->
            <div class="row section-tabla">
                <div class="panel-heading row col-lg-9 col-md-9">
                    <h1>Listado de Roles del Usuario</h1>
                </div>

                <div class="form-section col-lg-3 col-md-3">
                    <input type="button" class="pull-right btn-form" data-toggle="modal" data-target="#ModalAdicionarRol" value="Adicionar Rol" />
                </div>

                <div class="panel-body row col-lg-12 col-md-12">
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTable-lista-roles">
                            <thead>
                                <tr>
                                    <th>Rol</th>
                                    <th>Descripción</th>
        ...
        <div class="modal-dialog modal-dialog-centered  modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalBuscadorLongTitle">Buscar Colaborador</h5>
                ...
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            ...
                            <span class="col-lg-1 col-md-1 modal-btn-search" onclick="FiltrarColaboradores();">Buscar</span>
                        </div>
                        <div class="row">
                            <div class=" col-lg-12 col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="dataTable-colaboradores">
                                    ...
                                    <tbody id="lista_buscador_colaborador">                                        
                                    </tbody>
                                </table>
                            </div>
                        </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="ModalAdicionarRol" tabindex="-1" role="dialog" aria-labelledby="ModalAdicionarRolCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalAdicionarRolLongTitle">Adicionar Rol</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">                           
                            <div class="col-lg-12 col-md-12">
                                <label class="col-lg-3 col-md-3">Rol:</label>
                                <select class="col-lg-8 col-md-8" id="selRoles">                                    
                                </select>
                            </div>
                        </div>
                    </div>
    ...
    <script src="Recursos/js/Colaboradores/js_buscador_usuarios.js"></script>
    <script src="Recursos/js/Colaboradores/js_empleado_roles.js"></script>
